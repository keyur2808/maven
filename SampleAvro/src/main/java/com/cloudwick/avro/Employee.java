...
public class Employee extends org.apache.avro.specific.SpecificRecordBase
	...
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser()
			.parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"com.cloudwick.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"designation\",\"type\":[\"string\",\"null\"]},{\"name\":\"mgrid\",\"type\":[\"int\",\"null\"]},{\"name\":\"hiredate\",\"type\":\"string\"},{\"name\":\"salary\",\"type\":\"double\"},{\"name\":\"commission\",\"type\":[\"double\",\"null\"]},{\"name\":\"deptid\",\"type\":[\"int\",\"null\"]}]}");
	...
	public static com.cloudwick.avro.Employee.Builder newBuilder() {
		return new com.cloudwick.avro.Employee.Builder();
	}

	/** Creates a new Employee RecordBuilder by copying an existing Builder */
	public static com.cloudwick.avro.Employee.Builder newBuilder(
			com.cloudwick.avro.Employee.Builder other) {
		return new com.cloudwick.avro.Employee.Builder(other);
	}
	 ...
	 */
	public static com.cloudwick.avro.Employee.Builder newBuilder(
			com.cloudwick.avro.Employee other) {
		return new com.cloudwick.avro.Employee.Builder(other);
	}
	...
	public static class Builder extends
		...
		private Builder() {
			super(com.cloudwick.avro.Employee.SCHEMA$);
		}

		/** Creates a Builder by copying an existing Builder */
		private Builder(com.cloudwick.avro.Employee.Builder other) {
			super(other);
		...
		private Builder(com.cloudwick.avro.Employee other) {
			super(com.cloudwick.avro.Employee.SCHEMA$);
			if (isValidValue(fields()[0], other.id)) {
				this.id = data().deepCopy(fields()[0].schema(), other.id);
				fieldSetFlags()[0] = true;
		...
		/** Sets the value of the 'id' field */
		public com.cloudwick.avro.Employee.Builder setId(int value) {
		...
		public com.cloudwick.avro.Employee.Builder clearId() {
		...
		/** Sets the value of the 'name' field */
		public com.cloudwick.avro.Employee.Builder setName(
		...
		public com.cloudwick.avro.Employee.Builder clearName() {
			name = null;
		...
		/** Sets the value of the 'designation' field */
		public com.cloudwick.avro.Employee.Builder setDesignation(
				java.lang.CharSequence value) {
		...
		public com.cloudwick.avro.Employee.Builder clearDesignation() {
			designation = null;
		...
		/** Sets the value of the 'mgrid' field */
		public com.cloudwick.avro.Employee.Builder setMgrid(
		...
		public com.cloudwick.avro.Employee.Builder clearMgrid() {
			mgrid = null;
		...
		/** Sets the value of the 'hiredate' field */
		public com.cloudwick.avro.Employee.Builder setHiredate(
				java.lang.CharSequence value) {
		...
		public com.cloudwick.avro.Employee.Builder clearHiredate() {
			hiredate = null;
		...
		/** Sets the value of the 'salary' field */
		public com.cloudwick.avro.Employee.Builder setSalary(double value) {
		...
		public com.cloudwick.avro.Employee.Builder clearSalary() {
		...
		/** Sets the value of the 'commission' field */
		public com.cloudwick.avro.Employee.Builder setCommission(
		...
		public com.cloudwick.avro.Employee.Builder clearCommission() {
			commission = null;
		...
		/** Sets the value of the 'deptid' field */
		public com.cloudwick.avro.Employee.Builder setDeptid(
				java.lang.Integer value) {
		...
		public com.cloudwick.avro.Employee.Builder clearDeptid() {
			deptid = null;
